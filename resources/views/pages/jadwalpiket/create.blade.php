                    ...
                    <div class="col">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active font-weight-bold" aria-current="page">Tambah Data Jadwal Piket Santri</li>
                            </ol>
                          </nav>
                    </div>
                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body--">
                                <div class="container">
                                    <div class="row mt-3">
                                        <div class="col">
                                            <form action="{{url('/jadwalpiket/store')}}" method="post">
                                              @csrf
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <input type="text" class="form-control" id="tempat" name="tempat" placeholder="Masukan Penempatan Piket">
                                                </div>
